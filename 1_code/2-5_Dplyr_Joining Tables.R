...
sets %>%
  ...
  filter(version == 1) # results a table with 4976 observations, compared to 4977 in sets table. This means there's 1 set that doesn't have version 1, which is probably a data quality issue.
